...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2014 a las 08:03:11
...
CREATE TABLE IF NOT EXISTS `contactos` (
  `idContactos` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Clave Primaria Tabla Contactos',
  ...
  `Leido` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'Estado del Mensaje : No Leido, Leido',
  `Atendido` tinyint(1) DEFAULT '0',
  `Creado` datetime DEFAULT CURRENT_TIMESTAMP COMMENT 'Fecha del Mensaje',
...
(151, 18, 1418787312, 1418790912, 0, '::1', 1, 1418787312, NULL, NULL),
(152, 18, 1418793466, 1418797066, 0, '::1', 1, 1418793466, NULL, NULL),
(153, 18, 1418797539, 1418801139, 1, '::1', 1, 1418797539, NULL, NULL);
...
(18, 1417733533, NULL, 1418797539, 'admin', 'cafuentealbam@gmail.com', '71154121', 'ed30f99432fd28135834d01f4887db69', 1, 0, 0),
...
CREATE TABLE IF NOT EXISTS `necesidades` (
  `idNecesidades` int(10) NOT NULL AUTO_INCREMENT,
  ...
  `cruge_userr_id` int(11) NOT NULL COMMENT 'Clave primaria del usuario que tiene la solicitud',
  PRIMARY KEY (`idNecesidades`),
  KEY `fk_Necesidades_Categorias1_idx` (`Categorias_idCategorias`),
  KEY `fk_Necesidades_cruge_user1_idx` (`cruge_userr_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1 ;
...
INSERT INTO `productos` (`idProductos`, `Codigo`, `Nombre_Producto`, `Descripcion`, `Marca`, `Modelo`, `CodModelo`, `Tamano`, `Capacidad`, `TiempoDespacho`, `Stock`, `URLCatalogo`, `PrecioNormal`, `PedMin`, `Visitado`, `Destacado`, `Publicado`, `Borrado`, `Creado`, `Actualizado`, `EstadoStock_id`, `cruge_user_Prov_id`, `Categorias_id`) VALUES
(1, '1123', 'producto', 'descrpicion', 'chancho', '13231', '493216546', 'grande', '10 litros', 20, 10, '', 20000, 1, 0, 0, 1, 0, '2014-12-16 02:45:53', '2014-12-16 15:08:02', 1, 18, 6);
