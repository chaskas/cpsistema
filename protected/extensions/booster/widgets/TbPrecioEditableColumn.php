 ...
 * @package widgets
 */
class TbPrecioEditableColumn extends CDataColumn
{
    /**
    ...
    public function renderDataCellContent($row, $data)
    {
       ...
       $dcto = Productos::model()->TieneDescuentos($data->primaryKey);
        ...
        if(!empty($dcto)) {
            ...
            echo  CHtml::link( '<i class="fa fa-money"></i>',array('PreciosDesc/index',
                'pid'=>$data->primaryKey), array('data-toggle' =>'tooltip', 'title' => '', 'data-original-title' => 'Ver Precios'));
            //     }
        } else {
