 ...
 */
class TbToggleOneColumn extends TbDataColumn {
...
function() {
  if(!confirm('¿Está seguro, esto no se puede deshacer?')) return false;
	var th=this;
	...
	protected function renderDataCellContent($row, $data) {
        ...
        if ($checked) {
            ...
            $this->grid->controller->widget('TbEditableField', array(
                'type'      => 'text',
                'model'      => $data,
