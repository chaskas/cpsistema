...
function() {
    ...
    protected function renderDataCellContent($row, $data) {
      ...
      if ($data->TipoDesc_id == 2) {
          $Label = $this->checkedButtonLabel;
          $button['icon'] = $this->checkedIcon;

      } else  {
          $Label = $this->uncheckedButtonLabel;
          $button['icon'] = $this->uncheckedIcon;
       ...
       /* $checked = ($this->value === null)
        ...
        $button['url'] = isset($button['url']) ? $this->evaluateExpression(
         ...
         /*   $button['htmlOptions']['title'] = $this->getButtonLabel($checked);
            ...
            echo '<span data-toggle="tooltip" data-original-title="'.$Label.'" class="fa fa-' . $button['icon'] . '"></span>';
