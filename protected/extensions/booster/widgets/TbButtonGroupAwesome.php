<?php
/**
 *##  TbButtonGroupAwesome class file.
 *
...
Yii::import('booster.widgets.TbButtonAwesome');
 ...
 */
class TbButtonGroupAwesome extends CWidget {
	 ...
	 */
	public $buttonType = TbButtonAwesome::BUTTON_BUTTON;

	/**
	 * @var string the button type.
	 * @see BootButton::type
	 */
	public $context = TbButtonAwesome::CTX_DEFAULT;
	...
	public function run() {
		...
		foreach ($this->buttons as $button) {
			...
			$justifiedNotLink = $this->justified && $this->buttonType !== TbButtonAwesome::BUTTON_LINK;
			if($justifiedNotLink)
				echo '<div class="btn-group">';
			
			$this->controller->widget(
				'booster.widgets.TbButtonAwesome',
				array(
