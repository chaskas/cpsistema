...
class Categorias extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idCategorias, Nombre_Categoria', 'required'),
			array('idCategorias, Orden, Publicado, Borrado, Categorias_Parent_id', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'Categorias_Parent_id' => 'Categorias Parent',
		);
	}
